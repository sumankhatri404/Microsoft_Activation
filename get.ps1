...
$DownloadURL = 'https://github.com/sumankhatri404/Microsoft_Activation/blob/main/1st/MAS_AIO.cmd'
$DownloadURL2 = 'https://github.com/sumankhatri404/Microsoft_Activation/blob/main/2nd/MAS_AIO.cmd'
